...
/**
 * Normalizes title for exact matching comparison by removing spaces and special characters
 */
...
private suspend fun fetchTmdbAssets(document: Document, title: String, isSeries: Boolean): List<String?> {  
    return try {  
        ...
        if (exactMatch != null) {
            ...
            // "Method 3: Ultimate Fallback" is removed from here so no wrong images load.
        }
